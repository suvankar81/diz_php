...
<div class="row">
  ...
  <select class="form-control" id="" name="category" required="">
    ...
    <option value="Top30">শীর্ষ বার্তা</option>
    <option value="World">বিশ্ব-বার্তা</option>
    <option value="National">জাতীয়-বার্তা</option>
    <option value="Local">স্থানীয়-বার্তা</option>
    <option value="Editorial">সম্পাদকীয়</option>
    <option value="SPORTS">ক্রীড়া-বার্তা</option>
...
<!--     <div class="form-group">
      <label for="usr">News Body:</label>
      <textarea class="form-control jqte-test" id="ck" rows="5" name="nbody"  required=""></textarea>
    </div>-->
