        ...
        <header class="mdl-layout__header mdl-layout__header--waterfall portfolio-header">
            ...
            <div class="mdl-layout__header-row portfolio-navigation-row mdl-layout--large-screen-only" style="background: linear-gradient(to right, #BF0002, #440002);">
                <nav class="mdl-navigation mdl-typography--body-1-force-preferred-font" >
                    ...
                    <a class="mdl-navigation__link" href="/BN/" > Articles </a>
              ...
              <?php
                if($lnk==""){
                     $coni = new mysqli($host,$user,$pass,$db);
                      ...
                      $query = $coni->query("SELECT * FROM `news` WHERE `LANG`='BN' ORDER BY `id` DESC");
                     ...
                     elseif($lnk=="Top30") {
                      ...
                      $coni->query("SET character_set_results = 'utf8', character_set_client = 'utf8', character_set_connection = 'utf8', character_set_database = 'utf8', character_set_server = 'utf8'");
                          // mysqli_set_charset($conn,"utf8");
                      $query = $coni->query("SELECT * FROM `news` WHERE `LANG`='BN' AND `pri` BETWEEN 1 AND 30");
                      while($row = $query->fetch_assoc()){
                          $content = $row['N_CONTENT'];
                          $output =implode(' ', array_slice(explode(' ', $content), 0, 30));
                        echo '<div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                     ...
                     elseif($lnk=="World") {
                      ...
                      $coni->query("SET character_set_results = 'utf8', character_set_client = 'utf8', character_set_connection = 'utf8', character_set_database = 'utf8', character_set_server = 'utf8'");
                          // mysqli_set_charset($conn,"utf8");
                      $query = $coni->query("SELECT * FROM `news` WHERE `LANG`='BN' AND `N_CATEGORY`='World' ORDER BY `id` DESC");
                      while($row = $query->fetch_assoc()){
                          $content = $row['N_CONTENT'];
                          $output =implode(' ', array_slice(explode(' ', $content), 0, 30));
                        echo '<div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                     ...
                     elseif($lnk=="National") {
                      ...
                      $coni->query("SET character_set_results = 'utf8', character_set_client = 'utf8', character_set_connection = 'utf8', character_set_database = 'utf8', character_set_server = 'utf8'");
                          // mysqli_set_charset($conn,"utf8");
                      $query = $coni->query("SELECT * FROM `news` WHERE `LANG`='BN' AND `N_CATEGORY`='National' ORDER BY `id` DESC");
                      while($row = $query->fetch_assoc()){
                          $content = $row['N_CONTENT'];
                          $output =implode(' ', array_slice(explode(' ', $content), 0, 30));
                        echo '<div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                      ...
                      $coni->query("SET character_set_results = 'utf8', character_set_client = 'utf8', character_set_connection = 'utf8', character_set_database = 'utf8', character_set_server = 'utf8'");
                          // mysqli_set_charset($conn,"utf8");
                      $query = $coni->query("SELECT * FROM `news` WHERE `LANG`='BN' AND `N_CATEGORY`='Local' ORDER BY `id` DESC");
                      while($row = $query->fetch_assoc()){
                          $content = $row['N_CONTENT'];
                          $output =implode(' ', array_slice(explode(' ', $content), 0, 30));
                        echo '<div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                      ...
                      $coni->query("SET character_set_results = 'utf8', character_set_client = 'utf8', character_set_connection = 'utf8', character_set_database = 'utf8', character_set_server = 'utf8'");
                          // mysqli_set_charset($conn,"utf8");
                      $query = $coni->query("SELECT * FROM `news` WHERE `LANG`='BN' AND `N_CATEGORY`='Editorial' ORDER BY `id` DESC");
                      while($row = $query->fetch_assoc()){
                          $content = $row['N_CONTENT'];
                          $output =implode(' ', array_slice(explode(' ', $content), 0, 30));
                        echo '<div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
                      ...
                      $coni->query("SET character_set_results = 'utf8', character_set_client = 'utf8', character_set_connection = 'utf8', character_set_database = 'utf8', character_set_server = 'utf8'");
                          // mysqli_set_charset($conn,"utf8");
                      $query = $coni->query("SELECT * FROM `news` WHERE `LANG`='BN' AND `N_CATEGORY`='Sports' ORDER BY `id` DESC");
                      while($row = $query->fetch_assoc()){
                          $content = $row['N_CONTENT'];
                          $output =implode(' ', array_slice(explode(' ', $content), 0, 30));
                        echo '<div class="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
